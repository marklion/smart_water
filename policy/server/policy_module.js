        ...
        runtime_assignment: {
            ...
            func: async function (body, token) {
                try {
                    ...
                    // 总策略的「需要启动」被设为 false 时（界面点停止走的是 runtime_assignment），同步把所有轮灌组的 需要启动 设为 false，并设 需要跳过=true
        ...
        do_quick_action: {
            ...
            func: async function (body, token) {
                ...
                try {
                    ...
                    // 总策略点「停止」时，同步把所有轮灌组的 需要启动 设为 false，并设 需要跳过=true 让正在浇水/施肥的组立即进入收尾再回空闲
